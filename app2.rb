...
while user.life_player > 0 && (player1.life_player > 0 || player2.life_player > 0)
    ...
    break if enemies.all? { |enemie| enemie.life_player <= 0 }
	puts "Les autres joueurs attaquent !"
    enemies.each do |enemie|
    	enemie.attacks(user) if user.life_player > 0 && enemie.life_player > 0 
    end
end
if player3.life_player > 0
